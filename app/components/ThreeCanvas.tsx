...
import { BoxBlendGeometry, HeartGeometry } from '@/components/Three'
        ...
        <Canvas shadows orthographic camera={{ position: [0, 1.5, 10], zoom: 180 }}>
          ...
          <Physics colliders={false}>
            ...
            <RigidBody position={[0, -1, 0]} type="fixed" colliders="false">
              <CuboidCollider friction={2} restitution={0.5} args={[100, 0, 100]} />
            </RigidBody>
          </Physics>
          ...
          <ContactShadows resolution={1024} scale={20} position={[0, -1.02, 0]} blur={0.25} opacity={0.25} far={1.02} color="black" />
